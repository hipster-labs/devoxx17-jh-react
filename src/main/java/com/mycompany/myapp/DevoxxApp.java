...
public class DevoxxApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(DevoxxApp.class);

    private final Environment env;

    public DevoxxApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DevoxxApp.class);
